...
const DashboardPage = () => {
    ...
    useEffect(() => {
        ...
        if (!authToken) performNavigation('/login', { replace: true });
    }, [performNavigation]);
